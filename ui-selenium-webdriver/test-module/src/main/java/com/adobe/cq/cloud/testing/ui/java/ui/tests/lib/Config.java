...
public class Config {
  ...
  public static String SELENIUM_BASE_URL =
      System.getProperty("SELENIUM_BASE_URL", "http://localhost:4444");

  // AEM Author
  public static String AEM_AUTHOR_URL =
      System.getProperty("AEM_AUTHOR_URL", "http://localhost:4502");
  ...
  // AEM Publish
  public static String AEM_PUBLISH_URL =
      System.getProperty("AEM_PUBLISH_URL", "http://localhost:4503");
